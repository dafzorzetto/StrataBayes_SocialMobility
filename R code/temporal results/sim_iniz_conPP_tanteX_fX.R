...
sim_bin_2_2_X <- function(seed, n) {
  ...
  eta_0 <- matrix(c(10,1.5,1.3,2, 2, 3, 1,
                    1,1.1,0.75,1, 0.5, 1, 0,
                    -5,0.25,0.1,1, -0.2, 0.3, -1), nrow=3, ncol=7, byrow=TRUE)
  eta_1 <- matrix(c(2,1,1,1, 1, 0.3, 1.5,
                    0.5,0.5,0.5,0.5, 0.4, 0.3, 1,
                    -1,0.1,-1,0.1, -0.3, -0.4, -0.8), nrow=3, ncol=7, byrow=TRUE) #make values smaller
  ...
  mean_vector_1 <- rowSums(cbind(X[,1:4],-0.5*abs(X[,5]),exp(0.5*X[,6]),(P_1-P_0)^2)*eta_1[V,])
...
scenario_1_2_2_X <- lapply(1:samples, function(c) sim_bin_2_2_X(seed = c, n = n))
scenario_1_3_2_X <- lapply(1:samples, function(c) sim_bin_3_2_X(seed = c, n = n))

### --- scenarios based on second one ---
sim_bin_cont_2_2_X <- function(seed, n) {
  # set seed for reproducibility
  set.seed(seed)
  ...
  # Variables for outcome
  eta_0 <- matrix(c(10,1.5,1.3, 0.1, 0.4,-0.4,0.3, -0.7,0.2, 2,
                    1,1.1,0.75, 0.1, 0.4,-0.2,0.5, -0.7,0.2, 1,
                    -5,0.25,0.1, 0.1, 0.2,-0.4,0.1, -0.7, -0.2, -1), nrow=3, ncol=10, byrow=TRUE)
  eta_1 <- matrix(c(10,1,1, 0.4, 0.2,-0.2,0.1, -1,0.2, 3,
                    0,0.8,0.5, 0.1, 0.2,-0.4,0.1, -1,0.2,1,
                    -5,0.5,0.25, 0.1, 0.4,-0.2,0.1, -1,0.2,-1), nrow=3, ncol=10, byrow=TRUE) #make values smaller
  sigma_y_0 <- matrix(c(0.5,0.5,0.5))
  sigma_y_1 <- matrix(c(0.5,0.5,0.5))
  
  # Outcome
  #create for every unit a mean vector 
  mean_vector_0 <- rowSums(cbind(X[,c(1,4,5,6,7)],abs(X[,8]+1),exp(X[,9]+0.2),-0.5*abs(X[,10]),exp(0.5*X[,11]),P_0)*eta_0[V,])
  mean_vector_1 <- rowSums(cbind(X[,c(1,4,5,6,7)],abs(X[,8]+1),exp(X[,9]+0.2),-0.5*abs(X[,10]),exp(0.5*X[,11]),(P_1-P_0)^2)*eta_1[V,])
  Y_0 <- rnorm(n,mean_vector_0, sqrt(sigma_y_0[V,]))
  Y_1 <- rnorm(n,mean_vector_1, sqrt(sigma_y_1[V,]))
...
sim_bin_cont_3_2_X <- function(seed, n) {
  # set seed for reproducibility
  set.seed(seed)
...
scenario_2_2_2_X <- lapply(1:samples, function(c) sim_bin_cont_2_2_X(seed = c, n = n))
scenario_2_3_2_X <- lapply(1:samples, function(c) sim_bin_cont_3_2_X(seed = c, n = n))
...
plot_potential_P(scenario_1[[1]]$simulated_full$P_0,
                 ...
                 n_scenario=1)
plot_potential_P(scenario_1_3_X[[1]]$simulated_full$P_0,
                 scenario_1_3_X[[1]]$simulated_full$P_1,
                 scenario_1_3_X[[1]]$parameters$V,
                 n_scenario="1.3x")
plot_potential_P(scenario_1_3_2_X[[1]]$simulated_full$P_0,
                 ...
                 n_scenario="1.3.2x")
plot_potential_P(scenario_1_2_X[[1]]$simulated_full$P_0,
                 scenario_1_2_X[[1]]$simulated_full$P_1,
                 scenario_1_2_X[[1]]$parameters$V,
                 n_scenario="1.2x")
plot_potential_P(scenario_1_2_2_X[[1]]$simulated_full$P_0,
                 scenario_1_2_2_X[[1]]$simulated_full$P_1,
                 scenario_1_2_2_X[[1]]$parameters$V,
                 n_scenario="1.2.2x")
plot_potential_Y(scenario_1[[1]]$simulated_full$Y_0,
                 scenario_1[[1]]$simulated_full$Y_1,
                 scenario_1[[1]]$parameters$V,
                 n_scenario=1)
plot_potential_Y(scenario_1_3_X[[1]]$simulated_full$Y_0,
                 scenario_1_3_X[[1]]$simulated_full$Y_1,
                 scenario_1_3_X[[1]]$parameters$V,
                 n_scenario="1.3x")
plot_potential_Y(scenario_1_3_2_X[[1]]$simulated_full$Y_0,
                 ...
                 scenario_1_3_2_X[[1]]$parameters$V,
                 n_scenario="1.3.2x")
plot_potential_Y(scenario_1_2_X[[1]]$simulated_full$Y_0,
                 scenario_1_2_X[[1]]$simulated_full$Y_1,
                 scenario_1_2_X[[1]]$parameters$V,
                 n_scenario="1.2x")
plot_potential_Y(scenario_1_2_2_X[[1]]$simulated_full$Y_0,
                 scenario_1_2_2_X[[1]]$simulated_full$Y_1,
                 scenario_1_2_2_X[[1]]$parameters$V,
                 n_scenario="1.2.2x")
...
plot_potential_P(scenario_2[[1]]$simulated_full$P_0,
                 ...
                 n_scenario=2)
plot_potential_P(scenario_2_3_X[[1]]$simulated_full$P_0,
                 scenario_2_3_X[[1]]$simulated_full$P_1,
                 scenario_2_3_X[[1]]$parameters$V,
                 n_scenario="2.3x")
plot_potential_P(scenario_2_3_2_X[[1]]$simulated_full$P_0,
                 ...
                 n_scenario="2.3.2x")
plot_potential_P(scenario_2_2_X[[1]]$simulated_full$P_0,
                 scenario_2_2_X[[1]]$simulated_full$P_1,
                 scenario_2_2_X[[1]]$parameters$V,
                 n_scenario="2.2x")
plot_potential_P(scenario_2_2_2_X[[1]]$simulated_full$P_0,
                 scenario_2_2_2_X[[1]]$simulated_full$P_1,
                 scenario_2_2_2_X[[1]]$parameters$V,
                 n_scenario="2.2.2x")
...
plot_potential_Y(scenario_2[[1]]$simulated_full$Y_0,
                 ...
                 scenario_2[[1]]$parameters$V,
                 n_scenario=2)
plot_potential_Y(scenario_2_3_X[[1]]$simulated_full$Y_0,
                 scenario_2_3_X[[1]]$simulated_full$Y_1,
                 scenario_2_3_X[[1]]$parameters$V,
                 n_scenario="2.3x")
plot_potential_Y(scenario_2_3_2_X[[1]]$simulated_full$Y_0,
                 ...
                 scenario_2_3_2_X[[1]]$parameters$V,
                 n_scenario="2.3.2x")
plot_potential_Y(scenario_2_2_X[[1]]$simulated_full$Y_0,
                 scenario_2_2_X[[1]]$simulated_full$Y_1,
                 scenario_2_2_X[[1]]$parameters$V,
                 n_scenario="2.2x")
plot_potential_Y(scenario_2_2_2_X[[1]]$simulated_full$Y_0,
                 scenario_2_2_2_X[[1]]$simulated_full$Y_1,
                 scenario_2_2_2_X[[1]]$parameters$V,
                 n_scenario="2.2x")
...
hist_simulation(scenario_1_3_X, "Scenario 1.3 X")
hist_simulation(scenario_1_3_2_X, "Scenario 1.3.2 X")
hist_simulation(scenario_1_2_X, "Scenario 1.2 X")
hist_simulation(scenario_1_2_2_X, "Scenario 1.2.2 X")


hist_simulation(scenario_2, "Scenario 2")
hist_simulation(scenario_2_3_X, "Scenario 2.3 X")
hist_simulation(scenario_2_3_2_X, "Scenario 2.3.2 X")
hist_simulation(scenario_2_2_X, "Scenario 2.2 X" )
hist_simulation(scenario_2_2_2_X, "Scenario 2.2.2 X" )
