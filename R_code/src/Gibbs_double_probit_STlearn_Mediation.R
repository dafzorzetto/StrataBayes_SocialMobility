...
Double_probit_TSlearn_Mediation <- function(Outcome, Interm, Treat, Covariates, PScore = NA,
  ...
  outcome_Cov = cbind(interm_Cov, Treat, Interm)
  ...
  Cov_Imp_outcome_Tr0_Interm0[, dim_O_cov-1] = Cov_Imp_outcome_Tr0_Interm1[, dim_O_cov-1] = 0
  Cov_Imp_outcome_Tr1_Interm0[, dim_O_cov-1] = Cov_Imp_outcome_Tr1_Interm1[, dim_O_cov-1] = 1
