...
Double_probit_TT_learn_PS <- function(Outcome, Interm, Treat, Covariates,
  ...
  for (r in 1:R_tot){
    ...
    mean_eta_0 = sapply(1:L_max, function(l) eta_O_mu/eta_O_sigma_0 + Z_outcome_0[l,which(Outcome_alloc_0>=l)]%*%Cov_tilde0[[l]])
    ...
    mean_eta_1 = sapply(1:L_max, function(l) eta_O_mu/eta_O_sigma_1 + Z_outcome_1[l,which(Outcome_alloc_1>=l)]%*%Cov_tilde1[[l]])
